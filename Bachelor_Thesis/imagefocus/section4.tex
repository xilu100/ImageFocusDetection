...
for the later formal comparison. Specifically, they examine the PCA retention
ratio for the classical machine learning models and the number of training
epochs for the CNN under both the binary and three-class tasks. The selected
settings are then fixed in the subsequent main experiments.
