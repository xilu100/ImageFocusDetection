...
perform respectively? Third, when the task setting and training data
conditions change, what differences appear in the performance trends and
applicable scenarios of different methods? These questions define the
motivation and starting point of this work.
...
evaluated in a consistent way. Accordingly, this thesis considers both a
binary setting that distinguishes blurred and sharp patches and a three-class
setting that further includes an intermediate state.
...
\cite{krizhevsky2012imagenet,shu2018small,shorten2019survey}. When
...
unstable \cite{pertuz2013analysis}.
...
following sections present the experimental results based on the above theory
