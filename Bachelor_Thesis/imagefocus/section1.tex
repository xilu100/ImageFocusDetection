...
defocus blur \cite{lam2000iterative,yi2016lbp}. Therefore, whether an object is close to the focal plane is the
...
structure, and high-frequency response \cite{pertuz2013analysis,5739529}. In other words,
...
\par To avoid ambiguity caused by mixed use of terms in the following sections,
...
information loss \cite{yi2016lbp,pertuz2013analysis}. For this reason, patch-based representation
...
\cite{pertuz2013analysis,5739529}. These methods usually use gradient, edge, Laplacian
...
decision trees, or random forests for discrimination
\cite{cortes1995support,breiman2017classification,breiman2001random}. Such methods are often relatively
easy to implement and interpret, and they can remain competitive on small- or
medium-sized datasets \cite{pertuz2013analysis,cortes1995support,breiman2001random}. The second category is methods based on convolutional
...
models usually depend more on sufficient data support
\cite{goodfellow2016deep,shu2018small}. Especially for
patch-level tasks, both the quality and quantity of training samples directly
affect model stability \cite{shu2018small,shorten2019survey}.
...
be limited. Under such conditions, complex deep models may not always be the
most practical choice \cite{shu2018small,howard2017mobilenets,shorten2019survey}. Therefore, it is necessary to clarify the applicable boundaries of
...
\subsection{Overview of Research Approach}
