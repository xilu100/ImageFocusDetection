...
pipeline covering image preprocessing, automatic labeling, model training, and prediction evaluation. To
...
recognition performance and computational efficiency. The source code and
experimental pipeline are available on GitHub\footnote{\url{https://github.com/xilu100/ImageFocusDetection}}.
