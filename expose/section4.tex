...
\begin{enumerate}
          ...
          \begin{itemize}
              \item \textbf{Algorithms:}
                    \begin{itemize}
                        ...
                        \item Decision Tree
                        \item Random Forest
                        \item Clustering (for feature exploration / unsupervised analysis)
                    \end{itemize}
              \item \textbf{Features:}
                    \begin{itemize}
    ...
    \item \textbf{Neural Network Methods}
          \begin{itemize}
              \item \textbf{Algorithms:}
                    \begin{itemize}
                        \item Lightweight Convolutional Neural Network (CNN)
                        \item Transformer (attention mechanism for edge/blur focus)
                    \end{itemize}
          ...
          \begin{itemize}
              ...
              \item Evaluate:
                    \begin{itemize}
                        ...
                        \item Robustness across image types and blur levels
                        \item Training efficiency and data requirements
                    \end{itemize}
              \item Variables: sample size, classification type
          \end{itemize}
